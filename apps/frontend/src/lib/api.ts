...
export const api = {
  ...
  catalog: {
    ...
    search: (params: { page?: number; search?: string; warehouseId?: string; category?: string; type?: string; active?: string; listingStatus?: string; companyId?: string; inStock?: boolean; stockFilter?: string; pageSize?: number; sortBy?: string; sortDir?: 'asc' | 'desc' }, token: string) => {
      const q = new URLSearchParams();
